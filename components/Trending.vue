<template>
  <div id="trending-coins" class="mt-2">
    <p v-if="$fetchState.pending">Fetching Coins...</p>
    <p v-else-if="$fetchState.error">An error occured</p>
    <div v-else>
    <h1 class="ml-3 mb-1">Trending Coins</h1>
    <div v-for="coin of coins" :key="coin.id" class="focus:outline-none lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 bg-white p-6 shadow rounded">
